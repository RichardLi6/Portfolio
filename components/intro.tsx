  ...
  return (
    <section ref = {ref} id = "home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
        ...
        transition cursor-pointer borderBlack dark:bg-white/10" href="/Li_Richard_Resume.pdf" download> 
        ...
        transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60" href="https://www.linkedin.com/in/richard-li7/" target="_blank">
            <BsLinkedin />
        </a>
        ...
        transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60" href="https://github.com/RichardLi6" target="_blank">
            <FaGithubSquare />
        </a>
